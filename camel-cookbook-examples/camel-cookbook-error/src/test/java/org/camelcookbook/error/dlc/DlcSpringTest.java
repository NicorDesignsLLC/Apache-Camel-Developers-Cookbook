...
public class DlcSpringTest extends CamelSpringTestSupport {
    ...
    public void testDlq() throws Exception {
        ...
        mockResult.message(0).xquery(Exchange.EXCEPTION_CAUGHT).isNull();
        ...
        mockError.message(0).xquery(Exchange.EXCEPTION_CAUGHT).isNotNull();
        mockError.message(0).xquery(Exchange.FAILURE_ROUTE_ID).isEqualTo("myDlcRoute");
    ...
    public void testDlqMultistep() throws Exception {
        ...
        mockError.expectedBodiesReceived("KaBoom");
        mockError.message(0).xquery(Exchange.EXCEPTION_CAUGHT).isNotNull();
        mockError.message(0).xquery(Exchange.FAILURE_ROUTE_ID).isEqualTo("myFlakyRoute");
    ...
    public void testDlqMultistepOriginal() throws Exception {
        ...
        mockError.expectedBodiesReceived("KaBoom");
        mockError.message(0).xquery(Exchange.EXCEPTION_CAUGHT).isNotNull();
        mockError.message(0).xquery(Exchange.FAILURE_ROUTE_ID).isEqualTo("myFlakyRouteOriginal");
    ...
    public void testDlqUseOriginal() throws Exception {
        ...
        mockError.expectedBodiesReceived("KaBoom");
        mockError.message(0).xquery(Exchange.EXCEPTION_CAUGHT).isNotNull();
        mockError.message(0).xquery(Exchange.FAILURE_ROUTE_ID).isEqualTo("myDlcOriginalRoute");
